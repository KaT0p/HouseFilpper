<template>
  <div class="eb">
    ...
    <form v-on:submit.prevent="editBlog">
      <p>ชื่อผู้จ้าง : <input type="text" v-model="blog.title" /></p>
      ...
      <p><strong>ที่อยู่และติดต่อกลับ : </strong></p>
      <p>
        <vue-ckeditor 
      ...
      <p>สถานที่ : <input type="text" v-model="blog.category" /></p>
      <p>วันนัดทำความสะอาด: <input type="text" v-model="blog.status" /></p>
      <b-button-group><p>
        <b-button variant="success" type="submit">แก้ไข</b-button>
